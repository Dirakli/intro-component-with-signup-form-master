...
function Form() {
  ...
  const { register, handleSubmit, formState: { errors }, reset, setFocus } = useForm<FormErrors>();
  ...
  return (
    <div>
      <TryitforfreeButton onClick={() => setFocus("firstName")} >
        <TryitforfreeText >Try it free 7 days</TryitforfreeText>
